  ...
  return (
    <div className='flex flex-col bg-white dark:bg-night-gray shadow-lg transition duration-300 group dark:shadow-md hover:shadow-2xl dark:hover:shadow-night-teal rounded-lg p-5 pb-5 hover:cursor-pointer'>
      <Link href={project.projectSiteUrl} target='_blank'>
        <h1 className='transition duration-300 mb-8 cursor-pointer group-hover:text-blue-500 dark:group-hover:text-night-teal text-3xl lg:text-2xl font-semibold'>
          {project.title}
        </h1>

        <p className='cursor-pointer text-justify line-clamp-3 text-lg lg:text-sm text-gray-700 dark:text-gray-300 font-normal mb-8'>
          {project.description}
        </p>
      </Link>
