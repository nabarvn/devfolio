...
const Form = () => {
  ...
  return (
    <div className='relative bg-white dark:bg-night-gray shadow-lg rounded-lg p-8 pb-9 pt-10 md:pb-7'>
      ...
      <div className='mt-8 pb-2'>
        <button
          ...
          className='transition duration-300 transform bg-cyan-700 hover:bg-cyan-900 dark:bg-cyan-600 dark:hover:bg-cyan-700 inline-block text-lg font-medium rounded-full text-white px-3 py-1 cursor-pointer disabled:opacity-25 disabled:cursor-default disabled:hover:bg-cyan-700 disabled:dark:hover:bg-cyan-600'
        >
          Send
        </button>
