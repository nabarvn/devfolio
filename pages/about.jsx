          ...
          <div className=''>
            <div className='text-base md:text-lg font-semibold justify-center text-justify md:max-w-5xl lg:max-w-4xl xl:max-w-5xl md:px-4 lg:px-5 xl:px-9 pb-0'>
              <p className='mt-9'>
                ...
                on under the hood. And it was this memory that helped me
                understand certain things when the right time arrived. After
                putting a lot of thought into it, as you can probably tell, I
                chose to pursue engineering. Partly because I loved breaking and
                making things, and partly because someone had told me that
                engineers don&apos;t have to study as much (guilty!).
              </p>
              <p className='mt-9'>
