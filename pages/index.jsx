        ...
        <div className='col-span-1 md:col-span-10 lg:col-span-11'>
          <div className='flex flex-col md:px-9'>
            <Image
              ...
              height={100}
              width={100}
              className='align-middle h-20 w-20 md:h-28 md:w-28 float-left rounded-full'
              src='/nabarun.png'
            />
            ...
            <div id='layout-child' className='md:max-w-4xl mt-5 md:mt-7'>
              ...
              <div className='text-lg md:text-justify font-semibold cursor-default mt-5 md:mt-9'>
                <span className='flex'>
                  <span className='text-lg md:text-2xl italic text-cyan-700 dark:text-purple-300'>
                    Hi fren
                  </span>
                ...
                <span className='flex text-lg md:text-2xl italic text-cyan-700 dark:text-purple-300 mb-5'>
                  I am Nabarun
                </span>
                <p className='text-night-gray dark:text-gray-300 mb-5'>
                ...
                <Link href='/email'>
                  <button className='transition duration-300 transform bg-blue-500 dark:bg-night-blue hover:bg-blue-900 dark:hover:bg-indigo-700 inline-block text-lg font-medium rounded-full text-white px-3 py-1 cursor-pointer'>
                    Email Me!
                  </button>
                </Link>
              </div>
